...
function generateField(x, y) {
    ...
    const field = yArray.map(() => lodash.clone(xArray));
    field[x / 2][y / 2] = 1;
    field[x / 2 - 1][y / 2 - 1] = 1;
    field[x / 2 - 1][y / 2] = 2;
    field[x / 2][y / 2 - 1] = 2;
...
function calcReverseField(x_position, y_position, field, maxVal = 1000) {
...
class Othello {
    ...
    clickSlot(e, x, y) {
        ...
        let newField = lodash.cloneDeep(this.field);
        newField[y][x] = this.field[y][x] + this.player + 1;
        newField = calcReverseField(x, y, newField, this.maxval);
        if (lodash.flatten(this.field).reduce((a, b) => a + b) + this.player + 1
            == lodash.flatten(newField).reduce((a, b) => a + b)) {
            return;
        }
        this.field = newField;
   ...
   */
    ...
    render() {
        return h("div", null, h("table", null, this.field.map((xArr, yIndex) => h("tr", null, xArr.map((num, xIndex) => h("th", { class: [
                ...
                num === 0 ? 'unuse' : 'use',
                num % 2 === 0 ? 'blue' : 'red'
            ].join(' '), onClick: (e) => this.clickSlot(e, xIndex, yIndex) }, h("div", null, num)))))), h("div", { class: ['teban',
                this.player === 0 ? 'red' : 'blue'
            ].join(' ') }, this.player === 0
            ? '赤の番だよ!!'
            : '青の番だよ！！'), h("div", null, 'redのセルの数：' + this.countCellNum('red')), h("div", null, 'blueのセルの数：' + this.countCellNum('blue')), h("div", null, 'redのセルの中の合計値：' + this.countCellSum('red')), h("div", null, 'blueのセルの中の合計値：' + this.countCellSum('blue')), h("div", { class: "cp_iptxt" }, "\u8A31\u3055\u308C\u308B\u30BB\u30EB\u306E\u5024\u306E\u6700\u5927\u5024\uFF1A", h("input", { type: "number", value: this.maxval, onChange: (event) => { this.handleMaxValChange(event); } })), h("button", { class: "btn-square-little-rich", onClick: () => this.reset() }, "\u30EA\u30BB\u30C3\u30C8"));
    }
