...
export declare function calcReverseField(x_position: number, y_position: number, field: number[][], maxVal?: number): number[][];
 ...
 * @param arr
 */
export declare function calcReverse(pointVal: number, arr: PointObj[], maxVal?: number): PointObj[];
interface PointObj {
    x: number;
    y: number;
    pointVal: number;
