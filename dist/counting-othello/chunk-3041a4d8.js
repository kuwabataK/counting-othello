...
function generateField(x, y) {
    ...
    return yArray.map(() => lodash.clone(xArray));
}
function calcReverseField(x_position, y_position, field) {
    ...
    const newUpArr = this.calcReverse(newField[y_position][x_position], upArray);
    const newDownArr = this.calcReverse(newField[y_position][x_position], downArray);
    const newRightArr = this.calcReverse(newField[y_position][x_position], rightArray);
    const newLeftArr = this.calcReverse(newField[y_position][x_position], leftArray);
}
...
export { generateField as a, lodash as b, format as c };
