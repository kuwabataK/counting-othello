   ...
   */
    ...
    render() {
        return __chunk_1.h("div", null, __chunk_1.h("table", null, this.field.map((xArr, yIndex) => __chunk_1.h("tr", null, xArr.map((num, xIndex) => __chunk_1.h("th", { class: [
            ...
            ? 'レッドの番だよ!!'
            : 'ブルーの番だよ！！'), __chunk_1.h("div", null, 'レッドのセルの数：' + this.countCellNum('red')), __chunk_1.h("div", null, 'ブルーのセルの数：' + this.countCellNum('blue')), __chunk_1.h("div", null, 'レッドのセルの中の合計値：' + this.countCellSum('red')), __chunk_1.h("div", null, 'ブルーのセルの中の合計値：' + this.countCellSum('blue')), __chunk_1.h("div", { class: "cp_iptxt" }, "\u8A31\u3055\u308C\u308B\u30BB\u30EB\u306E\u5024\u306E\u6700\u5927\u5024\uFF1A", __chunk_1.h("input", { type: "number", value: this.maxval, onChange: (event) => { this.handleMaxValChange(event); } })));
    }
